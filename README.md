...
* `hathi_upd_YYYYMMDD.txt` hathifile, moved to /htapps/www/sites/www.hathitrust.org/files/hathifiles and indexed to `hf_*` tables via the [hathifiles database code](https://github.com/hathitrust/hathifiles_database)
...
* `hathi_full_YYYYMMDD.txt` hathifile, moved to /htapps/www/sites/www.hathitrust.org/files/hathifiles used to completely replace the hathifiles database tables.
