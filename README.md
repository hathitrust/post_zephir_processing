...
Data In
--------
* barcodes_YYY-MM-DD_ (previously: /exlibris/aleph/uprod/miu50/local/mdp/return/

Data Out
--------
* hathi_volumes_ingested_YYYYMMDD.txt sent to ftps.cdlib.org (untested, needs .netrc)
...
Data In
-------
* ht_bib_export_incr_YYYY-MM-DD.json.gz (incremental updates from Zephir)
* vufind_removed_cids_YYYY-MM-DD.txt.gz (CIDs that have gone away)
...
* zephir_upd_YYYYMMDD_dollar_dup.txt (generated by zephir_hathifile.pl, gets sent to Zephir)
* daily_touched_YYYY-MM-DD.txt.gz
* groove_incremental_YYYY-MM-DD.tsv.gz ( 
